# Download scripts
cd /scratch/richards/tomoko.nakanishi/data/TopMed
wget https://imputation.sanger.ac.uk/www/plink2ensembl.txt --no-check-certificate
wget https://www.well.ox.ac.uk//~wrayner/tools/HRC-1000G-check-bim-v4.3.0.zip --no-check-certificate
...
wget https://www.well.ox.ac.uk//~wrayner/tools/CreateTOPMed.zip --no-check-certificate
